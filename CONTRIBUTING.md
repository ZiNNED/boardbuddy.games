...
Thank you for your interest in contributing to Board Buddy! This guide will help you get started.

## How to Contribute

### Reporting Bugs

If you find a bug, please open an [issue](https://github.com/ZiNNED/boardbuddy.games/issues) and include:
...
Feature ideas are welcome! Please open an [issue](https://github.com/ZiNNED/boardbuddy.games/issues) with the **enhancement** label and describe:
...
```bash
# Clone the repo
git clone https://github.com/ZiNNED/boardbuddy.games.git
cd boardbuddy.games
